...
const prefix = '.';
const ownerNumber = ['94781209709']; // ඔයාගේ no එක දාන්න 🙄
...
async function connectToWhatsApp() {
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
           ...
           conn.sendMessage("94766863255@s.whatsapp.net", { image: { url: `https://i.ibb.co/5xzWmSxn/20250224-094453.png` }, caption: up }) // වෙනස් කරන්නහ්
